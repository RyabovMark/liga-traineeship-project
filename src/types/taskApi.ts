...
export type GetTaskRequest = paths['/tasks/{taskId}']['get']['parameters']['path'];

export type PatchTaskResponse = paths['/tasks/{taskId}']['patch']['parameters']['path'];
export type PatchTaskRequest = paths['/tasks/{taskId}']['patch']['responses'][200]['content']['application/json'];
